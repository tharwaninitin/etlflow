...
lazy val etlflowCore = ProjectRef(uri("git://github.com/tharwaninitin/etlflow.git#zio1"), "core")
lazy val etlflowScheduler = ProjectRef(uri("git://github.com/tharwaninitin/etlflow.git#zio1"), "scheduler")
