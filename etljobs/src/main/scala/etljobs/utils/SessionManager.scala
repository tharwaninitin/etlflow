...
abstract class SessionManager(global_properties: GlobalProperties) {
  ...
  def createSparkSession(ss: GlobalProperties): SparkSession = {
  ...
  def createBigQuerySession(ss: GlobalProperties): BigQuery = {
