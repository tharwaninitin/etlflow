...
object MyEtlJobProps {
  ...
  val local_subprocess = LOCAL_SUBPROCESS(
    "examples/target/docker/stage/opt/docker/bin/load-data",
    heap_min_memory = "-Xms100m",
  ...
  case class EtlJob2Props(
      ...
      ratings_output_dataset: String = "",
      ratings_output_table_name: String = "",
      ratings_output_file_name: Option[String] = Some("ratings.parquet")
  ) extends MyEtlJobProps
