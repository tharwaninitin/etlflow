...
class DbJobLogger(job_name: String, job_properties: EtlJobProps, job_run_id: String, is_master:String) extends ApplicationLogger {

  def logStart(start_time: Long, job_type: String): ZIO[DBServerEnv, Throwable, Unit] = {
  ...
  def logEnd(start_time: Long, error_message: Option[String] = None):  ZIO[DBServerEnv, Throwable, Unit]  = {
