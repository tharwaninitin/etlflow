...
object DbLogManager {
  def create(job_name: String, job_properties: EtlJobProps, config: Config, ec: ExecutionContext, blocker: Blocker, pool_name: String = "LoggerPool", job_run_id:String, is_master:String): Managed[Throwable, DbJobStepLogger] =
