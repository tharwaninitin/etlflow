          ...
          _                  <- BlazeServerBuilder[EtlFlowTask](runtime.platform.executor.asEC)
            ...
            .withHttpApp(
              Router[EtlFlowTask](
                ...
                "/assets/js/2.f5a58b19.chunk.js"      -> Kleisli.liftF(StaticFile.fromResource("static/assets/js/2.f5a58b19.chunk.js", blocker, None)),
                "/assets/js/main.c0dca78d.chunk.js"      -> Kleisli.liftF(StaticFile.fromResource("static/assets/js/main.c0dca78d.chunk.js", blocker, None)),
