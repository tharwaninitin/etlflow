          ...
          _                  <- BlazeServerBuilder[EtlFlowTask](runtime.platform.executor.asEC)
            ...
            .withHttpApp(
              Router[EtlFlowTask](
                ...
                "/assets/js/2.d4ea6f07.chunk.js"      -> Kleisli.liftF(StaticFile.fromResource("static/assets/js/2.d4ea6f07.chunk.js", blocker, None)),
                "/assets/js/main.3b7db998.chunk.js"      -> Kleisli.liftF(StaticFile.fromResource("static/assets/js/main.3b7db998.chunk.js", blocker, None)),
