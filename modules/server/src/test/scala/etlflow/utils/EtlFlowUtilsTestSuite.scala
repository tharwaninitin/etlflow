...
//
//  val props_map_job1: Map[String, String] = getJobPropsMapping[MyEtlJobPropsMapping[EtlJobProps,EtlJob[EtlJobProps]]]("Job1",etl_job_props_mapping_package)
//  val props_map_job2: Map[String, String] = getJobPropsMapping[MyEtlJobPropsMapping[EtlJobProps,EtlJob[EtlJobProps]]]("Job2",etl_job_props_mapping_package)
//
