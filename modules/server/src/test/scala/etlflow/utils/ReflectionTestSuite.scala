  ...
  val spec: ZSpec[environment.TestEnvironment, Any] =
    suite("Reflect Api")(
      test("getTypeFullName[MEJP] should return etlflow.jobtests.MyEtlJobPropsMapping") {
        assertTrue(RF.getTypeFullName[MEJP] == "etlflow.jobtests.MyEtlJobPropsMapping")
      },
...
//      },
      testM("getSubClasses[MEJP] should retrieve Set successfully") {
        assertM(RF.getSubClasses[MEJP])(
          equalTo(Set("Job1", "Job2", "Job3", "Job4", "Job5", "Job6", "Job7", "Job8", "Job9"))
        )
      },
      ...
      testM("getJob[MEJP](Job1) should return Job1") {
        ...
        assertM(ejpm)(
          equalTo(
            (
              "Job1",
              "etlflow.jobtests.jobs.Job1HelloWorld",
              "etlflow.jobtests.MyEtlJobProps.EtlJob1Props",
              "Job1HelloWorld(EtlJob1Props())"
            )
          )
        )
      },
