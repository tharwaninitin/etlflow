...
package object schema {
  case class Config(db: Credential.JDBC, timezone: Option[String], slack: Option[Slack], dataproc: Option[DataprocSpark], token: Option[List[String]], webserver: Option[WebServer])
